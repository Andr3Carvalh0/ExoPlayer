...
/* package */ final class SubtitlePainter {
  ...
  private int subtitleHorizontalMargin;
  private int subtitleVerticalMargin;
  private int subtitleRadius;
  ...
  public SubtitlePainter(Context context) {
    ...
    subtitleHorizontalMargin = (int) context.getResources().getDimension(R.dimen.subtitle_horizontal_padding);
	subtitleVerticalMargin = (int) context.getResources().getDimension(R.dimen.subtitle_vertical_padding);
	subtitleRadius = (int) context.getResources().getDimension(R.dimen.default_radius);
  }
  ...
  private void setupTextLayout() {
    ...
    ForegroundColorSpan[] foregroundColorSpans = cueTextEdge.getSpans(0, cueLength, ForegroundColorSpan.class);
  ...
  private void drawTextLayout(Canvas canvas) {
    ...
    if (Color.alpha(windowColor) > 0) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        canvas.drawRoundRect(-textPaddingX - subtitleHorizontalMargin, -subtitleVerticalMargin, layout.getWidth() + textPaddingX + subtitleHorizontalMargin, layout.getHeight() + subtitleVerticalMargin, subtitleRadius, subtitleRadius, paint);
      } else {
        canvas.drawRect(-textPaddingX - subtitleHorizontalMargin, -subtitleVerticalMargin, layout.getWidth() + textPaddingX + subtitleHorizontalMargin, layout.getHeight() + subtitleVerticalMargin, paint);
      }
    }
